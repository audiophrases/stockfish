@echo off
setlocal
title Chess Interface - yourlines suite
rem The Chess Interface is part of the yourlines chess suite. Starting it here
...
echo     Play    http://localhost:5173/play/   ^<- opening this app
